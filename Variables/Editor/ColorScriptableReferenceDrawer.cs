...
namespace ColdironTools.Scriptables
{
    ...
    /// </summary>
    [CustomPropertyDrawer(typeof(ColorScriptableReference))]
    public class ColorScriptableReferenceDrawer : PropertyDrawer
    {
        #region Fields
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty colorScriptable = property.FindPropertyRelative("referenceValue");
            ...
            EditorGUI.PropertyField(position,
                useLocal.boolValue ? localValue : colorScriptable,
                GUIContent.none);
